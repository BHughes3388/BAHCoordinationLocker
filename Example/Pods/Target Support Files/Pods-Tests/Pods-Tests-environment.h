...
#define COCOAPODS_POD_AVAILABLE_BAHCoordinationLocker
#define COCOAPODS_VERSION_MAJOR_BAHCoordinationLocker 0
#define COCOAPODS_VERSION_MINOR_BAHCoordinationLocker 1
#define COCOAPODS_VERSION_PATCH_BAHCoordinationLocker 0
